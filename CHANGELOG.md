...
- (GH-563) Build Image: Bump atc0005/go-ci from go-ci-oldstable-build-v0.22.10 to go-ci-oldstable-build-v0.23.14 in /dependabot/docker/builds
- (GH-542) CI Dependency: Bump actions/checkout from 4 to 6
- (GH-518) CI Dependency: Bump github/codeql-action from 3 to 4
- (GH-558) Go Dependency: Bump golang.org/x/crypto from 0.38.0 to 0.48.0
- (GH-559) Go Dependency: Bump golang.org/x/sys from 0.33.0 to 0.41.0
- (GH-569) go.mod: update minimum Go version to 1.25.0
- (GH-565) Remove "canary" Go version tracking

### Fixed

- (GH-567) Fix staticcheck QF1002 linting error
...
- (GH-478) Build Image: Bump atc0005/go-ci from go-ci-oldstable-build-v0.22.9 to go-ci-oldstable-build-v0.22.10 in /dependabot/docker/builds
- (GH-469) Go Dependency: Bump github.com/atc0005/go-nagios from 0.19.0 to 0.20.0
- (GH-473) Go Dependency: Bump golang.org/x/crypto from 0.37.0 to 0.38.0
- (GH-474) Go Dependency: Bump golang.org/x/sys from 0.32.0 to 0.33.0
- (GH-476) Go Runtime: Bump golang from 1.23.8 to 1.23.9 in /dependabot/docker/go
...
- (GH-309) Build Image: Bump atc0005/go-ci from go-ci-oldstable-build-v0.21.4 to go-ci-oldstable-build-v0.21.5 in /dependabot/docker/builds
- (GH-312) Build Image: Bump atc0005/go-ci from go-ci-oldstable-build-v0.21.5 to go-ci-oldstable-build-v0.21.6 in /dependabot/docker/builds
- (GH-314) Build Image: Bump atc0005/go-ci from go-ci-oldstable-build-v0.21.6 to go-ci-oldstable-build-v0.21.7 in /dependabot/docker/builds
- (GH-323) Build Image: Bump atc0005/go-ci from go-ci-oldstable-build-v0.21.7 to go-ci-oldstable-build-v0.21.8 in /dependabot/docker/builds
- (GH-320) Go Dependency: Bump golang.org/x/crypto from 0.25.0 to 0.26.0
- (GH-319) Go Dependency: Bump golang.org/x/sys from 0.22.0 to 0.23.0
- (GH-327) Go Dependency: Bump golang.org/x/sys from 0.23.0 to 0.24.0
- (GH-321) Go Runtime: Bump golang from 1.21.12 to 1.21.13 in /dependabot/docker/go

#### Other

- (GH-316) Push `REPO_VERSION` var into containers for builds
...
[Unreleased]: https://github.com/atc0005/check-ssh/compare/v0.3.21...HEAD
[v0.3.21]: https://github.com/atc0005/check-ssh/releases/tag/v0.3.21
[v0.3.20]: https://github.com/atc0005/check-ssh/releases/tag/v0.3.20
